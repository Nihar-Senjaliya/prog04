...
class Customer { 
    ...
    function read_record($id) { // display "read" form
        ...
        $this->generate_html_top(2);
				...
				<div class='control-group col-md-6'>
					...
					"; 
					if ($this->fileSize > 0) {
						$source = ' https://csis.svsu.edu/~nrsenjal/prog04/uploads/';
    ...
    function update_db_record ($id) {
		...
		$this->path ='/home/nrsenjal/public_html/prog04/uploads/' . $this->fileName;
				...
				if ($this->fieldsAllValid()) {
					...
					echo " 
						<div class='form-actions'>
							...
							<a href='https://csis.svsu.edu/~nrsenjal/prog04/uploads/' target='_blank'>Uploaded Pictures</a><br />";
					...
					foreach ($pdo->query($sql) as $row) {
						...
						if($temp != "") {
							...
							$path = '/home/nrsenjal/public_html/prog04/uploads/' . $row['fileName'];
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/Nihar-Senjaliya/prog04.git' target='_blank'>Github </a><br />
				<a href='https://csis.svsu.edu/~nrsenjal/prog04/uploads' target='_blank'>Uploaded Pictures</a><br />
        ...
        foreach ($pdo->query($sql) as $row) {
			...
			$temp = $row['fileName'];
			if($temp != "") {
				$pic = ' <img src=' . $source .  $row['fileName'] . ' width="75" height="75">   ';
			}
